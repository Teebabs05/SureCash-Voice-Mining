...
const BILL_PAYMENTS = [
  {
    ...
    description: "Buy airtime straight from your SureCash wallet.",
    raised: true,
    href: "/bills/airtime",
  },
  {
    ...
    description: "Buy data bundles straight from your SureCash wallet.",
    raised: false,
    href: "/bills/data",
  },
  {
    ...
    description: "Pay electricity bills straight from your SureCash wallet.",
    raised: false,
  ...
  },
  {
    ...
    color: "red" as const,
    description: "Renew TV subscriptions straight from your SureCash wallet.",
    raised: true,
    href: "/bills/cable-tv",
  },
  {
