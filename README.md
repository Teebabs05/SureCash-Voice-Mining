...
- `PAYSTACK_SECRET_KEY` — a real, confirmed integration (both deposits and instant withdrawal payouts); others (`MONNIFY_*`, `KORAPAY_*`, `PAYVESSEL_*`, `FLUTTERWAVE_*`) are stub adapters ready for real credentials
